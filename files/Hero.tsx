  ...
  return (
    <section style={{ padding: "5rem 0 4rem" }}>
      ...
      <p style={{
        ...
        Construindo sistemas que aprendem. Foco em Python, redes neurais e IA aplicada — com curiosidade como motor e a própria empresa como objetivo.
      </p>
      ...
      <div style={{ display: "flex", alignItems: "center", flexWrap: "wrap", gap: 12 }}>
        ...
        <div style={{ width: "0.5px", height: 24, background: "var(--border)", margin: "0 4px" }} />
