export function Footer() {
  return (
    <footer className="border-t border-[#1E2D45] bg-[#080C14] py-8">
      <div className="max-w-5xl mx-auto px-6 lg:px-8 flex items-center justify-between">
        ...
        <div className="flex items-center gap-5">
          ...
          <a href="mailto:luisvfernando7@gmail.com" aria-label="Email"
             className="text-[#484F58] hover:text-[#C9D1D9] transition-colors">
