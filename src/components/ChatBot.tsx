  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      role: "assistant",
      content:
        "Olá! Sou a IA do Luis Galvani. Sinta-se à vontade para perguntar sobre minha experiência, projetos ou tecnologias. Como posso ajudar?",
    },
  ]);
  ...
  return (
    <div className="chat-wrap">
      <div className="chat-header">
        ...
        <div>
          <p className="chat-header-title">IA do Luis Galvani</p>
